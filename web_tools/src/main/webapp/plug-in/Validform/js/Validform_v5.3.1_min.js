(function($, win, undef) {
	...
	Validform.util = {
		...
		ajax_check:function(tableName,fieldName,fieldVlaue,keyName,param){
			   //获取编辑页面的数据主键
					var obid = null;
					if(param!=null){
						 var obid_id = param;
		...
		check : function(curform, brothers, subpost, bool) {
			...
			if(validType!=null){
		       ...
		       var  ajaxResultValue=Validform.util.ajax_check(params[0],params[1],$(this).val(),params[2],$("input[name='"+params[2]+"']").val());
