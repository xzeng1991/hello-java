...
(function($) {
	...
	function _349(_34a, _34b) {
		...
		if (_34b.type == "all" || _34b.type == "header") {
			...
			if(opts.title.length>6){
				opts.title = opts.title.substring(0,6)+"...";
			}
			if (opts.header) {
	...
	var _6fc = $
			.extend(
					...
					_6ee([ "text", "textbox", "numberbox", "numberspinner",
							...
							"datetimebox", "timespinner", "datetimespinner", "checkbox", "radio" ]),
					{
						textarea : {
...
(function($) {
	...
	function _916(_917) {
		...
		var defaultSpinner = $(_917).attr('defaultSpinner');
		if(defaultSpinner&&null!=defaultSpinner&&''!=$.trim(defaultSpinner)){
			$(_917).datetimebox("spinner").timespinner("setValue", defaultSpinner);
		}
		...
		buttons : [
				{
					...
					handler : function(_a0e) {
						$(_a0e).datebox('setValue','').datebox('setText',''); 
	...
	$.fn.datetimebox.defaults = $.extend({}, $.fn.datebox.defaults,
			{
				...
				buttons : [ {
					...
					handler : function(_a2f) {
						$(_a2f).datebox('setValue','').datebox('setText',''); 
				...
				onSelect:function(date){
			        ...
			        $(this).datetimebox('setText', dateTime);
			        $(this).datetimebox('setValue', dateTime);
