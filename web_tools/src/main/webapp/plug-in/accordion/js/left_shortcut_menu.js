...
function addTab(subtitle, url, icon) {
	...
	var showtitle = subtitle;
	if(null!=subtitle&&subtitle.length>6){
		showtitle = showtitle.substring(0,6)+"...";
	}
	
	if (!$('#maintabs').tabs('exists', showtitle)) {
		...
		$('#maintabs').tabs('select', showtitle);
